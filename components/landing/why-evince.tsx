      ...
      <div className="max-w-4xl mx-auto">
        ...
        <ScrollReveal delay={0.15} className="max-w-2xl mx-auto space-y-6 text-muted-foreground text-base md:text-lg leading-relaxed text-center">
          <p>
            ...
            a property or help buyers imagine themselves living there.
          </p>

          <p>
            Evince was created to bridge that gap. By transforming listing photos into 
            cinematic property films, we help agents present homes with more atmosphere 
            and emotional impact, without requiring a full video shoot.
          </p>
