    ...
    <section id="pricing" className="py-24 md:py-32 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="rounded-3xl p-8 md:p-10 bg-card text-card-foreground shadow-lg border border-border">
          ...
          <div className="relative rounded-3xl p-8 md:p-10 bg-primary text-primary-foreground shadow-2xl ring-1 ring-primary/10 scale-[1.02]">
            {/* Best Value badge */}
